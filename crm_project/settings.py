...
SECRET_KEY = 'django-insecure-+v5zoz-^seb6l_mpmzidf5ibd9ygfod@pfxdo0%@%=fvz(4#70'
...
# Ajuste aqui para refletir a estrutura do seu projeto
STATICFILES_DIRS = [
